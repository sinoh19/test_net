...
void camera_turn()
{
    ...
    {
        if (player_1turn && A.isFire == false)
        {
            if (camera_x < A.left - 300)
            {
                camera_x += 10;
            }
            if (camera_x > A.left - 300)
        ...
        else if (player_2turn && B.isFire == false)
        {
            if (camera_x < B.left - 300)
            {
                camera_x += 10;
            }
            if (camera_x > B.left - 300)
